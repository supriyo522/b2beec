...
import "./Content.css"; // Assuming your CSS file is named App.css
...
const ContentImage = () => {
  return (
    <div className="contentimg">
      ...
      <p>
        <img
          src="https://10web-site.ai/210/wp-content/uploads/sites/242/2024/12/tenweb_media_PWxhQxNJ.webp"
          alt="School Management"
          className="float-image" // Applying the float class
        />
        Innovation and efficiency converge, driving progress and productivity.
        ...
        delivering solutions that meet the evolving needs of schools, educators,
